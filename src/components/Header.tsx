      ...
      <div>
        <FadeIn delay={0}>
          <h1 className="text-4xl font-bold tracking-tight text-slate-100 sm:text-5xl">
            <Link href="/" className="name-glow name-gradient hover:text-teal-400 transition-colors">Pooja Lekshmi J</Link>
          </h1>
        </FadeIn>
        <FadeIn delay={100}>
          <h2 className="mt-3 flex items-center gap-3 text-lg font-medium tracking-tight text-slate-200 sm:text-xl">
            Software Engineer
            <span className="inline-flex items-center gap-1.5 rounded-full bg-teal-400/10 px-3 py-0.5 text-xs font-medium text-teal-400">
        ...
        <FadeIn delay={200}>
          <p className="mt-4 max-w-xs text-base leading-relaxed text-slate-400">
            I build fast, reliable, and user-friendly web applications with modern technologies.
          </p>
        </FadeIn>
